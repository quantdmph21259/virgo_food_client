...
const WaitingConfirm = () => {
    ...
    const getObjectCurrent = async () => {
        ...
        try {
            ...
            if (value !== null) {
                const url = `${ConstString.url}${ConstString.api_get_order_waiting}${JSON.parse(value).id}`
                setLoading(true)
                fetch(url)
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{
                                            ...
                                            <TouchableOpacity style={{
                                                ...
                                                Alert.alert('Xác nhận', 'Bạn có muốn xác nhận hủy đơn?', [
                                                    {
                                                        text: 'Không',
                                                        style: 'cancel'
                                                    },
                                                    {
                                                        ...
                                                        onPress: () => {
                                                            setLoading(true)
                                                            const url = `${ConstString.url}${ConstString.api_cancel_order}${item.id}`
                                                            fetch(url, {
                                                                method: 'put',
                                                                headers: {
